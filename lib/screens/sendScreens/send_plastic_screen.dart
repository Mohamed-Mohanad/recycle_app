...
class sendPlastic extends StatefulWidget {
  @override
  _sendPlasticState createState() => _sendPlasticState();
}

class _sendPlasticState extends State<sendPlastic> {
  ...
  void _send(BuildContext context) {
    if (_formKey.currentState.validate()) {
      plasticQuantity = (int.parse(_quantityController.text));
