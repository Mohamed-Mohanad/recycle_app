...
class sendPaper extends StatefulWidget {
  @override
  _sendPaperState createState() => _sendPaperState();
}

class _sendPaperState extends State<sendPaper> {
  ...
  void _send(BuildContext context) {
    ...
    if (_formKey.currentState.validate()) {
      paperQuantity = (int.parse(_quantityController.text));
      showMyDialog(
        context: context,
        title: Text(
          "Confirm",
